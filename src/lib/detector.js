...
module.exports = {
     ...
     * @param {string} callback - a callback for the results
     */
     ...
     * @param {array} callback - a callback for the results for bad word and author as well
     */
    ...
    activity: { // Activity method
         ...
         * @param {array} callback - a callback for the results for timestamp
         */
    ...
    memo: { // Memo method
         ...
         * @param {string} username - account username
         * @param {array} callback - a callback for the results for memo  sender, receiver, amount, memo
         */
