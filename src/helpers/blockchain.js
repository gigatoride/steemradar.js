...
class Blockchain {
  ...
  transfer(senders, minAccount, receivers, targetMemo, callback) {
    ...
    if (senders !== null) {
      ...
      if (senders !== null && !utils.valid.accountName(senders)) {
  ...
  profane(username, callback) {
    if (username !== null && !utils.valid.accountName(username)) {
          ...
          // Stream latest blockchain transaction
            ...
            switch (txType) {
              ...
              // Check type of transaction
                if (username === null || txData.author === username) {
              ...
              case 'transfer':
              // Check type of transaction
                if (username === null || txData.from === username) {
                // Check if username is not null
